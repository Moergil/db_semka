...
public class ListTaxesOverviewView extends ProviderTableView<Payment, ListTaxesOverviewView.TaxesOverviewParams> {
    ...
    public ListTaxesOverviewView(Application application, String title) {
